        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MethodOfPaymentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MethodOfPaymentName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeRoomTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rooms", x => x.RoomId);
                    table.ForeignKey(
                        name: "FK_Rooms_RoomTypes_TypeRoomTypeId",
                        column: x => x.TypeRoomTypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastEditedUserUserId = table.Column<int>(type: "int", nullable: false),
                    ModifikationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_Users_CreatedUserUserId",
                        column: x => x.CreatedUserUserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_Reservations_Users_LastEditedUserUserId",
                        column: x => x.LastEditedUserUserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_CreatedUserUserId",
                table: "Reservations",
                column: "CreatedUserUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_LastEditedUserUserId",
                table: "Reservations",
                column: "LastEditedUserUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_MethodOfPaymentId",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_TypeRoomTypeId",
                table: "Rooms",
                column: "TypeRoomTypeId");
